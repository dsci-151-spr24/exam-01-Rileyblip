...
***The ten most common destinations for these flights are ORD and nine IAD locations. I first arranged the flights in descending order, and I selected the `destinations` and `flight` variables using the `select()` function.***
